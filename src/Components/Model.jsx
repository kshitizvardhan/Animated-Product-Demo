...
const Model = () => {
    ...
    // control of rotation value of each model
    const [smallRotation, setSmallRotation] = useState(0);
    const [largeRotation, setLargeRotation] = useState(0);

    // for the smooth animation between the small and large phones
    const tl = gsap.timeline();

    useEffect(()=>{
        if(size === "large"){
            animationWithGsapTimeline(tl, small, smallRotation, "#view1", "#view2", {
                // this is to move view1 away from the screen when the view is changed from view1 to view2
        ...
        if(size === "small"){
            animationWithGsapTimeline(tl, large, largeRotation, "#view2", "#view1", {
                // this is to bring back view1 which was away from the screen when the view is changed from view2 to view1
